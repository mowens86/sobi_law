...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-sm shift">
        <div class="container">
            ...
            <ul class="navbar-nav text-center ml-auto">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="#">Criminal Defense</a>
              ...
              <li class="nav-item">
                <a id="navbar-1" class="nav-link" href="#">Attorney Services</a>
              </li>
              <li class="nav-item">
                <a id="navbar-2" class="nav-link" href="#">About Me</a>
              </li>
              <li class="nav-item">
                <a id="navbar-3" class="nav-link" href="#">Contact Me</a>
              </li>
              <li class="nav-item">
                <a id="navbar-4" class="nav-link" href="tel:7605473915">Call: 760-547-3915</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <section id="main-info">
      ...
      <h4 id="main-info-cta" class="text-center"><strong>Call <a href="tel:7605473915">760-547-3915</a> to get started today.</strong></h4>
    </section>
    
    <section id="law-areas">
      <div class="container">
