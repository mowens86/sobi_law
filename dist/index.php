...
<html lang="en">
  ...
  <head>
    ...
    <meta name="description" content="Providing exceptional legal services and assisting families in Criminal Defense, Traffic and DUIs, Real Estate, and Civil Litigation cases throughout San Diego, Orange, Riverside, and Los Angeles Counties">
   ...
   <link rel="stylesheet" href="css/main.css">
    ...
    <title>Steven Sobieraj | Southern California's Attorney at Law</title>
  </head>
  ...
  <body>
    ...
    <section id="showcase" alt="Southern California Attorney at Law">
      <div class="overlay">
        <div class="container text-center">
          <h1>Providing Exceptional Legal Services at an Affordable Rate to Protect Your Legal Rights</h1>
          <a class="cta-button" href="#form">
            <span class="front">Schedule Your</span>
            <span class="center"></span>
            <span class="back">Free Consultation</span>
          </a>
        </div>
      </div>
    </section>
    ...
    <section id="main-info">
      <div class="container" class="border-top">
        ...
        <h4 class="text-center">Representing Clients in Criminal Defense, DUIs, Traffic Violations, Real Estate and Civil Litigation</h4>
        <div class="row">
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <p>Everyone deserves excellent criminal defense and Mr. Sobieraj is always prepared to take on charges ranging from misdemeanors, felony, DUI, drug crimes, domestic violence and even sex offenses. You deserve strong legal advocacy, and Mr. Sobieraj is committed to pursuing your best interests no matter what legal issue you face.</p>
          </div>
      </div>
      <h4 id="main-info-cta" class="text-center"><strong>Call <a class="phone" href="tel:7605473915">760-547-3915</a> to get started today.</strong></h4>
    </section>
    
    <section id="law-areas" alt="Areas of Law">
      <div class="law-overlay">
        <img class="img-fluid" src="img/Arrow-Banner.png">
        <div class="container">
          <h2 class="text-center h2-law">Areas of Law</h2>
